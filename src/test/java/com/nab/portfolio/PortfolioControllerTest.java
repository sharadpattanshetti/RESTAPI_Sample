...
public class PortfolioControllerTest {
	 ...
	 * 
	 * @Autowired PortfolioController portfolioController;
	 * 
	 ...
	 * standaloneSetup(this.portfolioController).build();// Standalone context
	 * 
	 * Project project1 = new Project(); project1.setName("ProjectTest1");
	 * project1.setDescription("ProjectTest1 Description");
	 * project1.setSummary("ProjectTest1 Summary"); project1.setCritical(true);
	 * project1.setEstimates(1);
	 * project1.setTypeMetadata(ProjectTypeMetadata.DocsManagement); Project
	 * project2 = new Project(); project2.setName("ProjectTest1");
	 ...
	 * 
	 * Contact contact = new Contact(); contact.setFirstName("Ryan");
	 * contact.setLastName("D"); List<Contact>contacts = new ArrayList<>();
	 ...
	 * }
	 * 
	 * @Test public void getProjects() throws Exception {
	 * 
	 ...
	 * )) .andExpect(status().isOk()) .andExpect(jsonPath("$[0].name",
	 * is("ProjectTest1"))) .andExpect(jsonPath("$[1].description",
	 * is("ProjectTest1 Description")));
	 * 
	 * 
	 * }
	 */
